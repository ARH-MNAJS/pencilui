...
const sheetVariants = cva(
  "pencil-border pencil-fill-paper fixed z-50 gap-4 p-6 shadow-lg transition ease-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
export const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(function SheetContent({ side = "right", className, children, pencilSeed, style, ...props }, ref) {
...
>(function SheetTitle({ className, ...props }, ref) {
  return (
    <SheetPrimitive.Title
      ...
      className={cn(
        "pencil-prose-display text-2xl leading-tight text-[var(--pencil-ink)]",
        className,
      )}
      {...props}
    />
